...
This line chart (Figure.1) presents 51 states and the United States death rate changing pattern during 18 years. 52 lines in total are included. According to this graph, the overall mortality rate in the United States is on a downward trend. Some states fluctuated in 2005 and 2008, but compared with 1999, the death rate of the entire United States in 2017 was significantly lower. The interactive version with detailed on hover is available on [website](https://njy530.github.io/pm566-project/#Time). 
...
This scatter plot (Figure.4) indicates 10 causes' age-adjusted death rate changing patter from 1999 to 2017. Bubble size is based on death number. This graph shows that except for heart disease and cancer, the death rates of the other eight causes of death in 18 years are all lower than 60, fluctuating within a specific range. Although they have been declining, the death rates from cancer and heart disease are still three to four times that of other causes of death. This means that heart disease and cancer are still the predominant leading causes of death in the United States.

<br>

It is worth noting that when we carefully observe these data. For most causes of death, the number of deaths is monotonously increasing rather than monotonously decreasing, such as cancer, Alzheimer's disease, etc. Interactive figure with detailed message in hover is available on [website](https://njy530.github.io/pm566-project/#Causes)

<br>

# Discussion

We can see from the previous conclusions that in terms of timeline, the death rate in the United States is showing a downward trend, which is associated the background of technological development and the improvement of medical standards. From a regional point of view, there is an abnormally high mortality rate in the Southeast region. Therefore, data on tobacco use was introduced to further explore possible explanations for this phenomenon. According to the regional distribution suggested by National Geographic [3], the entire United States is divided into five regions. Use the data on tobacco use in the United States from 2011 to 2019 [4] to study the prevalence of tobacco use in five regions (Figure.5)
...
This graph (Figure.5) indicates 5 regions tobacco use percentages from 2011 to 2019. The southeast region keeps the highest tobacco use percentage among these 5 regions. It's widely acknowledged that tobacco usage may induce various fatal diseases. Thus, the unusual high mortality in southeast area might associated with high tobacco use rate. 

<br>

As for the phenomenon that the mortality rate of certain diseases such as cancer have decreased and the number of deaths has increased, the possible explanations are the increasing in the population, the aging of the population, and with the development of science and technology and the improvement of medical standards, cancer is more and more easily detected.

<br>

# Conclusion and summary

In this project, we explore the changing pattern of age-adjusted death rate nationwide regarding time, region and causes. Overall, all-causes morality rate decrease significantly during 18 years. Regarding each specific cause of death, the mortality rate of cancer and heart disease is 3 to 4 times higher than that of other causes of death. Although their mortality rate is declining, they are still one of the leading causes of death in the United States. The other eight causes of death, including Alzheimer's disease, flu, stroke, etc., fluctuating at a relatively low level. From a regional perspective, the states of Hawaii, New York, and California had relatively low death rates in 2017, while the southeastern region, including Louisiana, Mississippi, and Georgia, etc., had relatively high death rates. The high rate of tobacco use in this region may be related to the high mortality rate.
